...
const ProjectSection = ({id,img1,title1,link1, description1,img2,title2,link2, description2,img3,title3,link3, description3,img4,title4,link4, description4,img5,title5,link5, description5,img6,title6,link6, description6}) => {
    return (
